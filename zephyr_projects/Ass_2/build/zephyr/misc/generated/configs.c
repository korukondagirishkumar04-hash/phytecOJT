...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BOARD_RUGGED_BOARD, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BOARD_RUGGED_BOARD_STM32F446XX, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BOARD_QUALIFIERS, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BOARD_REVISION_1_1_0, 1);
