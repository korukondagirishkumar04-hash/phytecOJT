...
const struct _isr_table_entry __sw_isr_table _sw_isr_table[97] = {
	...
	{(const void *)0x8003f37, (ISR)0x8000e91}, /* 6 */
	{(const void *)0x8003f35, (ISR)0x8000e91}, /* 7 */
	{(const void *)0x8003f33, (ISR)0x8000e91}, /* 8 */
	{(const void *)0x8003f31, (ISR)0x8000e91}, /* 9 */
	{(const void *)0x8003f2f, (ISR)0x8000e91}, /* 10 */
	...
	{(const void *)0x8003f2d, (ISR)0x8000e91}, /* 23 */
	...
	{(const void *)0x8003f2b, (ISR)0x8000e91}, /* 40 */
