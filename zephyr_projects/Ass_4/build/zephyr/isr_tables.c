...
const struct _isr_table_entry __sw_isr_table _sw_isr_table[97] = {
	...
	{(const void *)0x8003faf, (ISR)0x8000f0d}, /* 6 */
	{(const void *)0x8003fad, (ISR)0x8000f0d}, /* 7 */
	{(const void *)0x8003fab, (ISR)0x8000f0d}, /* 8 */
	{(const void *)0x8003fa9, (ISR)0x8000f0d}, /* 9 */
	{(const void *)0x8003fa7, (ISR)0x8000f0d}, /* 10 */
	...
	{(const void *)0x8003fa5, (ISR)0x8000f0d}, /* 23 */
	...
	{(const void *)0x8003fa3, (ISR)0x8000f0d}, /* 40 */
